...
@click="pickPre(currentYear, currentMonth)">❮</button>
<span class="oprButton title-data">{{ nowFullYear }}/{{ nowMonth }}/{{ nowDay }}</span>
<button class="rt oprButton oprButton-bg mr10"
@click="pickNext(currentYear,currentMonth)">❯</button>
<!-- <button class="lf oprButton oprButton-bg ml5"
...
width: 100%;
height: 100%;
background:linear-gradient( 270deg, rgba(254, 154, 139, 1) 0%, rgba(253, 134, 140, 1) 72%, rgba(247, 140, 160, 1) 100%);
}
//日历表头
.monthHeader{
height:$line10*6.6;
